...
def train():
    ...
    train_datasets=torchvision.datasets.CIFAR100('./data/',train=True,transform= transform_train,download=False)
    val_datasets=torchvision.datasets.CIFAR100('./data/',train=False,transform=transform_val,download=False)
