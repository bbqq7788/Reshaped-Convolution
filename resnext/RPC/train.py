...
def train():
    ...
    train_datasets=torchvision.datasets.CIFAR100('/public/home/zhanglei2022/pth/cifar100',train=True,transform= transform_train,download=False)
    val_datasets=torchvision.datasets.CIFAR100('/public/home/zhanglei2022/pth/cifar100',train=False,transform=transform_val,download=False)
