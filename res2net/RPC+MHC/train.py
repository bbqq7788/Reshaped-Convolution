...
import torch
from skip import res2net50_14w_8s
...
def train():
    ...
    train_datasets=torchvision.datasets.CIFAR100('./data',train=True,transform= transform_train,download=True)
    val_datasets=torchvision.datasets.CIFAR100('./data',train=False,transform=transform_val,download=True)
    ...
    net=res2net50_14w_8s().to(device)
    ...
    for epoch in range(500):
        ...
        torch.save(net, './w/' + str(epoch) + '_redesigned_se.pth')
